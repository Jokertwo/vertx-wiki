...
//    public static final String CONFIG_WIKIDB_QUEUE = "wikidb.queue";
    ...
    public void start(Future<Void> startFuture) throws Exception {
        wikiDbQueue = config().getString(WikiDatabaseVerticle.CONFIG_WIKIDB_QUEUE, WikiDatabaseVerticle.CONFIG_WIKIDB_QUEUE);
            ...
            if (reply.succeeded()) {
                ...
                templateEngine.render(context.data(), "templates/index.ftl", ar -> {
                    if (ar.succeeded()) {
                        ...
                        LOGGER.error("Render index fail");
                        context.fail(ar.cause());
                    }
                });
            } else {
                LOGGER.error("Event bus index fails, message {}",reply.cause());
